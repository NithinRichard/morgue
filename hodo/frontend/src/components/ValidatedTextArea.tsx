  ...
  return (
    <div className="form-group">
      ...
      <div className="form-textarea-container">
        ...
        {hasError && (
          <div className="form-textarea-error-icon">
      ...
      {(showCharacterCount || maxLength) && (
        <div className={`form-character-count ${isNearLimit ? 'form-character-count-warning' : ''} ${isOverLimit ? 'form-character-count-error' : ''}`}>
